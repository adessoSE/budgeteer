...
public interface ContractRepository extends CrudRepository<ContractEntity, Long>{
     ...
     */
    @Query("select new de.adesso.budgeteer.persistence.contract.ContractStatisticBean" +
            "(:year+0," + // year
     ...
     */
    @Query("select new de.adesso.budgeteer.persistence.contract.ContractStatisticBean(:year+0," + //year
