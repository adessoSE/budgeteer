...
import de.adesso.budgeteer.web.pages.budgets.overview.report.BudgetReportFileModel;
    ...
    protected void onSubmit() {
        ...
        if((getModelObject()).getTemplate() == null){
            ...
            IModel<File> fileModel = new BudgetReportFileModel(BudgeteerSession.get().getProjectId(),
                    model(LazyModel.from(BudgeteerSession.get().getBudgetFilter())), getModel(), model(from(getModel()).getTemplate()));
