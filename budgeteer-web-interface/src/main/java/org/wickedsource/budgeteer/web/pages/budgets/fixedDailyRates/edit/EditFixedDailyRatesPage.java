...
import org.wickedsource.budgeteer.web.pages.budgets.fixedDailyRates.edit.form.EditFixedDailyRateForm;

import static org.wicketstuff.lazymodel.LazyModel.from;
import static org.wicketstuff.lazymodel.LazyModel.model;

@Mount({"budgets/details/fixedDailyRates/edit/${RecordId}", "budgets/details/fixedDailyRates/edit"})
public class EditFixedDailyRatesPage extends DialogPageWithBacklink {
     ...
     */
    public EditFixedDailyRatesPage(Class<? extends WebPage> backlinkPage, PageParameters backlinkParameters) {
        super(backlinkPage, backlinkParameters);
        isEditing = false;
        Form<FixedDailyRate> form = new EditFixedDailyRateForm("form", backlinkParameters);
        addComponents(form);
    }
     ...
     */
    public EditFixedDailyRatesPage(PageParameters parameters, Class<? extends WebPage> backlinkPage, PageParameters backlinkParameters, boolean isEditingNewRecord, boolean isSaveResponse) {
        super(parameters, backlinkPage, backlinkParameters);
        isEditing = true;
        FixedDailyRate record = service.loadFixedDailyRate(getManualRecordId());
        Form<FixedDailyRate> form = new EditFixedDailyRateForm("form", model(from(record)), backlinkParameters, isEditingNewRecord, isSaveResponse);
        addComponents(form);
    }

    private void addComponents(Form<FixedDailyRate> form) {
