...
public class DateRangeInputField extends TextField<DateRange> {
  ...
  public static enum DROP_LOCATION {
    UP,
    DOWN
  }
  ...
  public DateRangeInputField(
      String id, IModel<DateRange> model, DateRange defaultRange, DROP_LOCATION drop_location) {
    super(id, model);
