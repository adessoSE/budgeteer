...
public class BudgetNotesPage extends BasePage {
  ...
  public BudgetNotesPage(PageParameters pageParameters) {
    ...
    Form<EditBudgetData> form = new BudgetNotesForm("form", Model.of(budgetData));
    add(form);
  }
  ...
  protected BreadcrumbsModel getBreadcrumbsModel() {
    ...
    model.addBreadcrumb(
        new Breadcrumb(BudgetNotesPage.class, getPageParameters(), getString("breadcrumb.title")));
    return model;
  }
