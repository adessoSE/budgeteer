...
public class BudgetDetailsPage extends BasePage {
	...
	public BudgetDetailsPage(PageParameters parameters) {
		super(parameters);
		model =
				new AbstractReadOnlyModel<BudgetDetailData>() {
					@Override
		...
		add(
				new PeopleDistributionChart(
						"distributionChart", new PeopleDistributionChartModel(getParameterId())));
		add(
				new BookmarkablePageLink<SingleBudgetWeekReportPage>(
						"weekReportLink",
						SingleBudgetWeekReportPage.class,
						createParameters(getParameterId())));
		add(
				new BookmarkablePageLink<SingleBudgetMonthReportPage>(
						"monthReportLink",
						SingleBudgetMonthReportPage.class,
						createParameters(getParameterId())));
		addContractLinks();
		add(
				...
				new Label(
						...
						new AbstractReadOnlyModel() {
							...
							public String getObject() {
								return StringUtils.isBlank(model.getObject().getContractName())
