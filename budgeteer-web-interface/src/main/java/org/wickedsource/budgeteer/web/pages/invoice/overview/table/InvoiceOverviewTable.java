		...
		table.add(
				new ListView<InvoiceBaseData>("invoiceRows", model(from(data).getInvoices())) {
					...
					protected void populateItem(final ListItem<InvoiceBaseData> item) {
						...
						Link link =
								new Link("showInvoice") {
									@Override
									public void onClick() {
										WebPage page =
												new InvoiceDetailsPage(InvoiceDetailsPage.createParameters(invoiceId)) {
													...
													protected BreadcrumbsModel getBreadcrumbsModel() {
														...
														m.addBreadcrumb(
																...
																InvoiceDetailsPage.createParameters(invoiceId));
														return m;
													}
												};
						...
						Link contractLink =
								new Link("contractLink") {
									...
									public void onClick() {
										WebPage page =
												new ContractDetailsPage(
														ContractDetailsPage.createParameters(
																item.getModelObject().getContractId())) {
						...
						item.add(
								new BookmarkablePageLink<EditInvoicePage>(
										"editLink",
										EditInvoicePage.class,
