...
public class ChartUtils {
	...
	/**
	 * Creates a list of labels for the last numberOfWeeks weeks, including the current week. This
	 * list can be used for labels in a chart.
	 *
	 * @param numberOfWeeks the number of weeks to go back into the past.
	 * @param weekLabelFormat the format of the week labels. Should contain "%s" as a placeholder for
	 *     the week number.
	...
	/**
	 * Creates a list of labels for the last numberOfMonths months, including the current month. This
	 * list can be used for labels in a chart.
	 *
