...
/**
 * Wicket EventBehavior that works in JQuery-Datatables. If there are multiple EventBehaviors added
 * to on Table, there may get a strange behavior because this EventBehavior works with classes
 * instead of ids. Elements that can trigger the Event get the class wicketBehavior + eventName
 * (e.g. wicketBehaviorclick)
 */
public abstract class CustomDataTableEventBehavior extends AbstractDefaultAjaxBehavior {
	 ...
	 *
	 * @param target the current request handler
	 */
