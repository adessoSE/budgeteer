...
public class EditContractForm extends Form<ContractBaseData> {
    ...
    private void addComponents() {
        ...
        table.add(new ListView<ContractFieldData>("contractAttributes", model(from(getModelObject()).getContractAttributes())) {
            @Override
        ...
        Button addAttribute = new AjaxButton("addAttribute") {
            ...
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                if(newAttributeField.getModelObject() != null) {
                    ((ContractBaseData) form.getModelObject()).getContractAttributes().add(new ContractFieldData(newAttributeField.getModelObject(), ""));
