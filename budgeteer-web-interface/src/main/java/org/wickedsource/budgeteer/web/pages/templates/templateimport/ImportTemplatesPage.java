...
public class ImportTemplatesPage extends DialogPageWithBacklink {
  ...
  public ImportTemplatesPage(
    ...
    var formModel = Model.of(templateFormInputDto);
          ...
          protected void onSubmit(AjaxRequestTarget target) {
            ...
            try {
              ...
              if (templateFormInputDto.getName() != null
                ...
                service.doImport(
                    BudgeteerSession.get().getProjectId(), file, Model.of(templateFormInputDto));
    ...
    form.add(
        new TextField<>("name", of(templateFormInputDto::getName, templateFormInputDto::setName)));
    form.add(
        new TextField<>(
            "description",
  ...
  private DropDownChoice createExampleFileList(String wicketId) {
    DropDownChoice<ReportType> dropDownChoice =
        new DropDownChoice<ReportType>(
            wicketId,
            new Model<>(exampleTemplateType),
