...
public class MultiselectBehavior extends Behavior {
	 ...
	 *
	 * @param options @see <a
	 *     href="http://davidstutz.github.io/bootstrap-multiselect/#configuration-options">Options</a>
	 */
	...
	public void renderHead(Component component, IHeaderResponse response) {
		response.render(
				CssHeaderItem.forReference(BudgeteerReferences.getBootstrapMultiselectCssReference()));
		response.render(
		...
		response.render(
				JavaScriptReferenceHeaderItem.forReference(
						BudgeteerReferences.getBootstrapMultiselectJSReference()));
	...
	/**
	 * Returns a HashMap with the budgeteer-typical-options set. The set options are:
	 * includeSelectAllOption, buttonWidth, maxHeight, numberDisplayed, buttonClass, enableFiltering,
	 * maxHeight
	 *
