...
public class BreadcrumbsModel implements IModel<List<Breadcrumb>> {
	...
	/**
	 * Convenience constructor. Creates breadcrumbs for all page classes passed into the constructor.
	 * Uses the property "breadcrumb.title" of the page as the title for the breadcrumbs. If you want
	 * to specify the title yourself, use the constructor that takes Breadcrumb objects as parameters.
	 *
	...
	/**
	 * Convenience method for adding a breadcrumb to the page passed as parameter. The title of the
	 * breadcrumb will be loaded from the property "breadcrumb.title" of the specifiec page class.
	 *
