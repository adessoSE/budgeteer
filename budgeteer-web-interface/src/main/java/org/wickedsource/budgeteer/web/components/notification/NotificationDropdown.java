package org.wickedsource.budgeteer.web.components.notification;
...
public class NotificationDropdown extends Panel {
    ...
    private WebMarkupContainer createDropdownMenu(String wicketId) {
        final ListView<Notification> listview = new ListView<Notification>("notificationList", getModel().getObject()) {
            @Override
