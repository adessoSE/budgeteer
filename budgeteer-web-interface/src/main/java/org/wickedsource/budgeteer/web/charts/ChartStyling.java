...
public class ChartStyling {
	...
	public static Layout getLayout() {
		return new Layout().setPadding(new Padding().setBottom(15).setLeft(10).setTop(10).setRight(10));
	}
						...
						new AxesScale()
								.setTicks(
										new Ticks()
												...
												.setFontSize(ChartStyling.getFontSize()))
								.setGridLines(
										new GridLines().setDisplay(false).setColor(new RgbColor(230, 230, 230))));
	}
