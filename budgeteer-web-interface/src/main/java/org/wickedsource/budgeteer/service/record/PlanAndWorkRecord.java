...
public class PlanAndWorkRecord {
    ...
    public PlanAndWorkRecord(WeeklyAggregatedRecordWithTaxBean planBean) {
        ...
        valueInCentsPlanned_gross = MoneyUtil.getCentsWithTaxes(planBean.getValueInCents(), planBean.getTaxRate());
    ...
    public PlanAndWorkRecord(WeeklyAggregatedRecordWithTitleAndTaxBean workBean) {
        ...
        valueInCentsBurned_gross = MoneyUtil.getCentsWithTaxes(workBean.getValueInCents(), workBean.getTaxRate());
    ...
    public PlanAndWorkRecord(MonthlyAggregatedRecordWithTaxBean bean, boolean plan) {
        ...
        if (plan) {
            ...
            valueInCentsPlanned_gross = MoneyUtil.getCentsWithTaxes(bean.getValueInCents(), bean.getTaxRate());
            valueInCentsBurned = 0;
            valueInCentsBurned_gross = 0;
        } else {
            ...
            valueInCentsBurned_gross = MoneyUtil.getCentsWithTaxes(bean.getValueInCents(), bean.getTaxRate());
        }
    }
}
