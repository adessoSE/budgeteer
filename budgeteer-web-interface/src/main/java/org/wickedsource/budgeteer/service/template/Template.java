...
/**
 * This class contains all the data for a Template. The id attribute is not auto-generated like with
 * TemplateEntity, it is instead passed into the constructor.
 */
@Getter
public class Template implements Serializable {
	...
	/**
	 * @param id the ID for the template - this must be the same as the auto-generated id of the
	 *     corresponding TemplateEntity.
