...
public class WorkRecordQueries {
	...
	/**
	 * @deprecated should be re-implemented using criteria api to load "flat" objects instead of a
	 *     WorkRecordEntity!!!
	 */
	@Deprecated
	...
	private static BooleanExpression getBudgetExpression(
			WorkRecordFilter filter, QWorkRecordEntity record) {
	...
	private static BooleanExpression getPersonExpression(
			WorkRecordFilter filter, QWorkRecordEntity record) {
		BooleanExpression result = null;
