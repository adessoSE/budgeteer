...
/**
 * A custom {@link SecurityExpressionRoot} that implements the {@link
 * MethodSecurityExpressionOperations} interface for the default expressions like {@link
 * #hasPermission(Object, Object)}.
 *
 * <p>All expression evaluation is performed by the currently selected project of the user.
 *
 * @see BudgeteerSession#getProjectId()
 */
@Component
public class BudgeteerMethodSecurityExpressionRoot extends SecurityExpressionRoot
  ...
  /**
   * A custom expression to evaluate if the user is allowed to read the budget.
   *
   * @param budgetId The id of the budget to retrieve.
   * @return <i>true</i>, if the id of the budget is valid and the {@link BudgetEntity}'s project
   *     has the same id as the currently selected project by the user, <i>false</i> otherwise.
   * @see BudgeteerSession#getProjectId()
   */
   ...
   * @return <i>true</i>, if the currently selected project has the same id as the given one.
   * @see BudgeteerSession#getProjectId()
   */
   ...
   * @return <i>true</i>, if the associated project of the contract has the same id as the currently
   ...
   * @return <i>true</i>, if the associated project of the person has the same id as the currently
   *     selected project by the user.
   * @see BudgeteerSession#getProjectId()
   */
