...
@Component
public class MissingBudgetTotalNotificationMapper extends AbstractMapper<MissingBudgetTotal, Notification> {

    @Override
    public Notification map(MissingBudgetTotal missingTotal) {
