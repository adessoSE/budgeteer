...
@Table(
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          name = "UNIQUE_IMPORT_KEY_PER_PROJECT",
          columnNames = {"PROJECT_ID", "IMPORT_KEY"}),
      @UniqueConstraint(
...
public class BudgetEntity implements Comparable<BudgetEntity> {
  ...
  public boolean equals(Object o) {
    ...
    if (dailyRates != null ? !dailyRates.equals(that.dailyRates) : that.dailyRates != null)
      return false;
    if (importKey != null ? !importKey.equals(that.importKey) : that.importKey != null)
      return false;
    ...
    if (workRecords != null ? !workRecords.equals(that.workRecords) : that.workRecords != null)
      return false;
