...
class RecordJoinerTest extends ServiceTestTemplate {
	...
	void testJoinWeekly() throws Exception {
		...
		Assertions.assertEquals(
				MoneyUtil.createMoneyFromCents(50000), records.get(0).getBudgetBurned());
		Assertions.assertEquals(
				MoneyUtil.createMoneyFromCents(12300), records.get(0).getBudgetPlanned());
		...
		Assertions.assertEquals(
				MoneyUtil.createMoneyFromCents(50000), records.get(1).getBudgetBurned());
		Assertions.assertEquals(
				MoneyUtil.createMoneyFromCents(12300), records.get(1).getBudgetPlanned());
		...
		Assertions.assertEquals(
				MoneyUtil.createMoneyFromCents(60000), records.get(2).getBudgetBurned());
		Assertions.assertEquals(
				MoneyUtil.createMoneyFromCents(32100), records.get(2).getBudgetPlanned());
