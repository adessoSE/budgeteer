...
class BudgetRepositoryTest extends IntegrationTestTemplate {
	...
	void testFindByAtLeastOneTag() {
		List<BudgetEntity> budgets =
				budgetRepository.findByAtLeastOneTag(1L, Arrays.asList("Tag 1", "Tag 3"));
	...
	void testGetMissingBudgetTotalsForProject() {
		List<MissingBudgetTotalBean> missingTotals =
				budgetRepository.getMissingBudgetTotalsForProject(1L);
