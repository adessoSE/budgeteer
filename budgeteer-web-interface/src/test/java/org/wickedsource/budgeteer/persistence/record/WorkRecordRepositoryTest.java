...
class WorkRecordRepositoryTest extends IntegrationTestTemplate {
	...
	@Autowired private WorkRecordRepository repository;
	...
	void testGetSpentBudgetInTimeRange() throws Exception {
		double value =
				repository.getSpentBudgetInTimeRange(
						1L, format.parse("15.08.2015"), format.parse("16.08.2015"));
	...
	void testGetTotalHoursInTimeRange() throws Exception {
		double value =
				repository.getTotalHoursInTimeRange(
						1L, format.parse("15.08.2015"), format.parse("16.08.2015"));
	...
	void testGetTotalHoursInTimeRangeAndNoRecordsAreInTimeRange() throws Exception {
		double value =
				repository.getTotalHoursInTimeRange(
						1L, format.parse("15.08.2010"), format.parse("16.08.2011"));
	...
	@DatabaseTearDown(
		value = "getAverageDailyRateZeroMinutes.xml",
	...
	@DatabaseTearDown(
		value = "getTotalHoursByBudgetIdAndUntilDate.xml",
		type = DatabaseOperation.DELETE_ALL
	)
	...
	@DatabaseTearDown(
		value = "getFirstWorkRecordDateByBudgetIds.xml",
		type = DatabaseOperation.DELETE_ALL
	)
	...
	void testUpdateWorkRecordDailyRates() throws Exception {
		repository.updateDailyRates(
				1L,
				1L,
				format.parse("01.01.2015"),
				format.parse("15.08.2015"),
				MoneyUtil.createMoneyFromCents(50000L));
	...
	void testAggregatedByWeekAndBudgetTags() {
		List<WeeklyAggregatedRecordBean> records =
				repository.aggregateByWeekAndBudgetTags(1L, Arrays.asList("tag1"));
	...
	void testAggregatedByMonthAndBudgetTags() {
		List<MonthlyAggregatedRecordBean> records =
				repository.aggregateByMonthAndBudgetTags(1L, Arrays.asList("tag1"));
		Assertions.assertEquals(2, records.size());
	...
	void testAggregateByWeekForProject() throws ParseException {
		List<WeeklyAggregatedRecordBean> records =
				repository.aggregateByWeekForProject(1L, format.parse("02.01.2015"));
		Assertions.assertEquals(2, records.size());
	...
	void testAggregateByWeekForPerson() throws ParseException {
		List<WeeklyAggregatedRecordBean> records =
				repository.aggregateByWeekForPerson(1L, format.parse("02.01.2015"));
	...
	void testAggregateByMonthForPerson() throws ParseException {
		List<MonthlyAggregatedRecordBean> records =
				repository.aggregateByMonthForPerson(1L, format.parse("01.01.2015"));
		Assertions.assertEquals(1, records.size());
	...
	@DatabaseTearDown(
		value = "aggregateByMonthAndBudgetForPerson.xml",
		type = DatabaseOperation.DELETE_ALL
	)
	void testAggregateByMonthAndBudgetForPerson() throws ParseException {
		List<MonthlyAggregatedRecordWithTitleBean> records =
				repository.aggregateByMonthAndBudgetForPerson(1L, format.parse("01.01.2015"));
		Assertions.assertEquals(2, records.size());
	...
	@DatabaseTearDown(
		value = "aggregateByMonthAndPersonForBudget.xml",
		type = DatabaseOperation.DELETE_ALL
	)
	void testAggregateByMonthAndPersonForBudget() throws ParseException {
		List<MonthlyAggregatedRecordWithTitleBean> records =
				repository.aggregateByMonthAndPersonForBudget(1L, format.parse("01.01.2015"));
		Assertions.assertEquals(1, records.size());
	...
	@DatabaseTearDown(
		value = "aggregateByWeekAndBudgetForPerson.xml",
		type = DatabaseOperation.DELETE_ALL
	)
	void testAggregateByWeekAndBudgetForPerson() throws ParseException {
		List<WeeklyAggregatedRecordWithTitleBean> records =
				repository.aggregateByWeekAndBudgetForPerson(1L, format.parse("01.01.2015"));
		Assertions.assertEquals(2, records.size());
	...
	void testAggregateByWeekAndPersonForBudget() throws ParseException {
		List<WeeklyAggregatedRecordWithTitleBean> records =
				repository.aggregateByWeekAndPersonForBudget(1L, format.parse("01.01.2015"));
		Assertions.assertEquals(1, records.size());
	...
	void testGetAverageDailyRatePerDay() throws ParseException {
		List<DailyAverageRateBean> records =
				repository.getAverageDailyRatesPerDay(1L, format.parse("01.01.2015"));
		Assertions.assertEquals(2, records.size());
	...
	void testAggregateByMonthForBudget() throws ParseException {
		List<MonthlyAggregatedRecordBean> records =
				repository.aggregateByMonthForBudget(1L, format.parse("01.01.2015"));
		Assertions.assertEquals(1, records.size());
	...
	void testAggregateByWeekForBudget() throws ParseException {
		List<WeeklyAggregatedRecordBean> records =
				repository.aggregateByWeekForBudget(1L, format.parse("01.01.2015"));
		Assertions.assertEquals(1, records.size());
	...
	void testAggregateByWeekAndPersonForBudgets() throws ParseException {
		List<WeeklyAggregatedRecordWithTitleBean> records =
				repository.aggregateByWeekAndPersonForBudgets(
						1L, Arrays.asList("tag1"), format.parse("01.01.2015"));
		Assertions.assertEquals(2, records.size());
	...
	void testAggregateByMonthForBudgets() throws ParseException {
		List<MonthlyAggregatedRecordBean> records =
				repository.aggregateByMonthForBudgets(
						1L, Arrays.asList("tag1"), format.parse("01.01.2015"));
		Assertions.assertEquals(2, records.size());
	...
	@DatabaseTearDown(
		value = "aggregateByMonthAndPersonForBudgets.xml",
		type = DatabaseOperation.DELETE_ALL
	)
	void testAggregateByMonthAndPersonForBudgets() throws ParseException {
		List<MonthlyAggregatedRecordWithTitleBean> records =
				repository.aggregateByMonthAndPersonForBudgets(
						1L, Arrays.asList("tag1"), format.parse("01.01.2015"));
		Assertions.assertEquals(3, records.size());
	...
	void testFindManuallyEditedEntries() throws ParseException {
		...
		List<WorkRecordEntity> records =
				repository.findManuallyEditedEntries(2L, formatter.parse("2014-01-01"), new Date());
		Assertions.assertEquals(0, records.size());

		records =
				repository.findManuallyEditedEntries(
						1L, formatter.parse("2014-01-01"), formatter.parse("2016-08-15"));
		Assertions.assertEquals(1, records.size());

		records =
				repository.findManuallyEditedEntries(
						1L, formatter.parse("2014-01-01"), formatter.parse("2016-08-14"));
		Assertions.assertEquals(0, records.size());

		records =
				repository.findManuallyEditedEntries(
						1L, formatter.parse("2012-01-01"), formatter.parse("2016-08-14"));
		Assertions.assertEquals(1, records.size());

		records =
				repository.findManuallyEditedEntries(
						1L, formatter.parse("2012-01-01"), formatter.parse("2016-08-16"));
		Assertions.assertEquals(2, records.size());
	}
	...
	void testFindDuplicateEntries() throws ParseException {
		...
		List<WorkRecordEntity> records =
				repository.findDuplicateEntries(budget, person, formatter.parse("2014-01-01"), 480);
		Assertions.assertEquals(1, records.size());
