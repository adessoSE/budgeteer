...
@Component
public class BudgeteerAdminConsoleApplication extends WebApplication implements ApplicationContextAware {
    ...
    @Autowired
    public BudgeteerAdminConsoleApplication(BudgeteerSettings settings) {
        this.settings = settings;
    }

    @Override
    public Class<? extends WebPage> getHomePage() {
        return BudgeteerAdministrationOverview.class;
    }
