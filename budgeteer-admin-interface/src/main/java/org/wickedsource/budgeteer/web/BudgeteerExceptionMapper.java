...
public class BudgeteerExceptionMapper extends DefaultExceptionMapper {
     ...
     *          to the {@link org.wickedsource.budgeteer.web.pages.administration.ProjectAdministrationPage}.
     */
    private IRequestHandler handleAccessDenied(Exception ex) {
        return new RenderPageRequestHandler(new PageProvider(ProjectAdministrationPage.class));
    }
