...
class PowerBiWorkRecordsImporterTest {
    ...
    void acceptsValidPowerBiImportHeader() throws IOException {
        ...
        var workbook = new XSSFWorkbook(new FileInputStream("src/test/resources/power-bi-valid-header.xlsx"));
    ...
    void rejectsInvalidPowerBiImportHeader() throws IOException {
        var importer = new PowerBiWorkRecordsImporter();
        var workbook = new XSSFWorkbook(new FileInputStream("src/test/resources/power-bi-invalid-header.xlsx"));
