...
class ResourcePlanImporterTest {
  ...
  void testImportFile() throws Exception {
    ...
    ImportFile file =
        new ImportFile("resource_plan.xlsx", getClass().getResourceAsStream("/resource_plan.xlsx"));
  ...
  void testInvalidFile() {
    Assertions.assertThrows(
        ...
        () -> {
          ...
          ImportFile file =
              new ImportFile(
                  "resource_plan_invalid.xlsx",
                  getClass().getResourceAsStream("/resource_plan_invalid.xlsx"));
