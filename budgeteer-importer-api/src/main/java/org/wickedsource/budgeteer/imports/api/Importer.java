...
public interface Importer extends Serializable {
	...
	/**
	 * Returns an example file that contains data in the format that this importer understands. This
	 * file can be downloaded by the user to learn the import format.
	 *
	 ...
	 * The skipped sets are returned by this method. The values of each data set was converted to
	 * Strings
	 *
	 * @return List of skipped data sets or null if there weren't any because the importer didn't
	 *     skipp data sets
	 */
