...
class DailyRateRepositoryTest extends DbUnitDataJpaTestBase {
  ...
  void testFindByBudgetAndPersonWithOverlappingDateRange() throws ParseException {
    ...
    List<DailyRateEntity> rates =
        rateRepository.findByBudgetAndPersonWithOverlappingDateRange(
            2L, 1L, formatter.parse("20.02.2015"), formatter.parse("25.02.2015"));
  ...
  void testFindByBudgetAndPersonEndingInOrAfterDateRange() throws ParseException {
    SimpleDateFormat formatter = new SimpleDateFormat("dd.MM.yyyy");
    List<DailyRateEntity> rates =
        rateRepository.findByBudgetAndPersonEndingInOrAfterDateRange(
            2L, 1L, formatter.parse("21.02.2015"));
